...
It is not just the accuracy of the technology that is important, but the creation of strategic value. Tai and Wang state that in data analytics, insight-driven organizational agility argues that business analytics enhances “data-driven strategic foresight,” which increases organizational agility. This is because the use of descriptive, predictive, and prescriptive analytics enables an organization to foresee challenges, thereby allowing it to react proactively. 
