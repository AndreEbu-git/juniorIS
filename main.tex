...
This feature will help SME owners who lack data science expertise. This way, instead of manually configuring the model, users can simply interact with the system using sliders and obtain summaries. The feasibility of this integration has been validated in educational analytics, suggesting strong potential for extension to business contexts.
